...
//	private static DatePersoanaPanel instance;
	...
	lblSubunitate, lblUnitate_1, lblSubunitate_1, lblLucratorSaesp;

//	public static synchronized DatePersoanaPanel getInstanceOf() {
//		if (instance == null) {
//			instance = new DatePersoanaPanel();
//		}
//		return instance;
//
//	}
	...
	public DatePersoanaPanel() {
		...
		lblNume.setBounds(10, 58, 218, 36); add(lblNume);
		...
		tfCNPSolicitant.setBounds(206, 105, 955, 36); add(tfCNPSolicitant);
